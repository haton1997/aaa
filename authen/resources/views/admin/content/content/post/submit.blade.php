    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            <form name="category" action="{{url('admin/content/post')}}" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">Danh mục bài viết</label>
                    <div class="col-sm-8">
                        <select name="cat_id">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control1" name="author_id" value="{{old('author_id')}}" id="focusedinput" placeholder="Default Input">
                    </div>
                </div>
                <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">View</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control1" name="view" value="{{old('view')}}" id="focusedinput" placeholder="Default Input">
                    </div>
                </div>
